      ...
      <div className="modal-content glass fade-in" onClick={(e) => e.stopPropagation()}>
        ...
        {isOrdered ? (
          <div className="success-message fade-in">
            ...
            <h2 style={{ fontSize: '1.8rem', fontWeight: '800', color: '#059669', marginBottom: '0.75rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.4rem', flexWrap: 'wrap-reverse' }}>
              <span>تشكركم على تقتكم ❤️</span>
              <span dir="ltr">Naslmla7</span>
            </h2>
